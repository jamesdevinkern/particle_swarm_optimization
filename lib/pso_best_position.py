...
for iXXXX in [83]:
    ...
    for iTown in radius:
        ...
        def PSO_Animation(cost_function, X, bounds, numParticles, maxIter, b):
            numDim = len(X)
            bestGroupError = -999
            posGroupBest = [0,0]
            ...
            while i < maxIter:
                ...
                for j in range(0, numParticles):
                    swarm[j].evaluate_cost(cost_function)
        ...
        class Particle:
            ...
            def evaluate_cost(self,cost_function):
                self.errIndividual = cost_function(self.positionIndividual)
